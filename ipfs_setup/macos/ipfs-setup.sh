...
echo "=========================================="
echo "IPFS Kubo Auto Setup - macOS"
echo "=========================================="
...
DOWNLOAD_URL="https://dist.ipfs.tech/kubo/${KUBO_VERSION}/kubo_${KUBO_VERSION}_darwin-${ARCH_NAME}.tar.gz"
TAR_FILE="kubo_${KUBO_VERSION}_darwin-${ARCH_NAME}.tar.gz"

echo "Step 1: Downloading IPFS Kubo ${KUBO_VERSION} for macOS ${ARCH_NAME}..."
...
echo "Note: You may need to allow IPFS through macOS firewall"
echo "=========================================="